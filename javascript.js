...
document.getElementById("signin-form").addEventListener("submit", function(event) {
    ...
    window.location.href = "welcome.html"; // Change "welcome.html" to the URL of your desired destination page
});
...
document.getElementById("signin-form").addEventListener("submit", function(event) {
    ...
    // You can add your sign-in logic here
    console.log("Sign in with username: " + username + " and password: " + password);
    // Redirect to another HTML website after successful sign-in
    window.location.href = "http://127.0.0.1:59041/html.html"; // Replace "https://example.com" with the URL of the other website
});
...
document.getElementById("signup-form").addEventListener("submit", function(event) {
    ...
    // You can add your sign-up logic here
    console.log("Sign up with username: " + username + ", email: " + email + ", and password: " + password);
    // Redirect to another HTML website after successful sign-up
    window.location.href = "http://127.0.0.1:59041/html.html"; // Replace "https://example.com" with the URL of the other website
});
